        ...
        <div style="margin: 120px 600px">
            ...
            <h2 style="color: orange; font-family: tahoma;">Hi <?= $user->getSESSION("username")?>, Welcome to VINID APP 
              <a href="<?= $router->createUrl("logout") ?>" class="btn btn-danger" style="font-size: 20px; float: right">Logout</a>
                ...
                <h1 style="font-weight: bolder; color: white">Do you want to delete: <?= $postsdetail["name"] ?> </h1><br>
            <div class="show-data" style="width: 60%">
                <form action="<?php echo $router->createUrl('posts/delete', ["id" =>$id]) ?>" method="POST">
                    ...
                    <input style="float: left" class="list-group-item list-group-item-success" onclick="window.location.href = '<?= $router->createUrl("posts/index") ?>'" type="button" value="Cancel">   
                </form> 
